...
func showUsage() {
	fmt.Println(`
Usage:
installer -version [version] -lib [llama.cpp .so file path] -processor [cpu, cuda, cuda-12, cuda-13, metal, openvino, rocm, vulkan]`)
}
...
func handleFlags() error {
	...
	processor = flag.String("processor", "", "processor to use (cpu, cuda, cuda-12, cuda-13, metal, openvino, rocm, vulkan)")
