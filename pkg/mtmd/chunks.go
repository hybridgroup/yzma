...
func loadChunkFuncs(lib ffi.Lib) error {
	...
	if inputChunksSizeFunc, err = lib.Prep("mtmd_input_chunks_size", &ffi.TypeUint64, &ffi.TypePointer); err != nil {
		return loadError("mtmd_input_chunks_size", err)
	}

	if inputChunksGetFunc, err = lib.Prep("mtmd_input_chunks_get", &ffi.TypePointer, &ffi.TypePointer, &ffi.TypeUint64); err != nil {
	...
	if inputChunkGetNTokensFunc, err = lib.Prep("mtmd_input_chunk_get_n_tokens", &ffi.TypeUint64, &ffi.TypePointer); err != nil {
	...
	if inputImageTokensGetNTokensFunc, err = lib.Prep("mtmd_image_tokens_get_n_tokens", &ffi.TypeUint64, &ffi.TypePointer); err != nil {
		return loadError("mtmd_image_tokens_get_n_tokens", err)
	}

	if inputImageTokensGetNXFunc, err = lib.Prep("mtmd_image_tokens_get_nx", &ffi.TypeUint64, &ffi.TypePointer); err != nil {
		return loadError("mtmd_image_tokens_get_nx", err)
	}

	if inputImageTokensGetNYFunc, err = lib.Prep("mtmd_image_tokens_get_ny", &ffi.TypeUint64, &ffi.TypePointer); err != nil {
